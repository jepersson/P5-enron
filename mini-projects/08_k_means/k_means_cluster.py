...
# Check out max and min for exercised_stock_options variable
exercised_stock_options = [x["exercised_stock_options"]
                           for x
                           in data_dict.values()
                           if x["exercised_stock_options"] != "NaN"]

print "exercised_stock_options maximum: "
print max(exercised_stock_options)
print "exercised_stock_options minimum: "
print min(exercised_stock_options)

# Now let's do the same for salary variable
salary = [x["salary"]
          for x
          in data_dict.values()
          if x["salary"] != "NaN"]

print "salary maximum: "
print max(salary)
